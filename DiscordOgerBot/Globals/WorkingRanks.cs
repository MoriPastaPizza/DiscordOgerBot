...
namespace DiscordOgerBot.Globals
{
    public static class WorkingRanks
    {
        public static readonly List<WorkingRankProperties> TimeForRanks = new List<WorkingRankProperties>
        {
            ...
            new WorkingRankProperties{Time = TimeSpan.FromHours(10), Rank = 5, RankId = 791992226347089951, ImageUrl = "https://raw.githubusercontent.com/MoriPastaPizza/DiscordOgerBot/master/DiscordOgerBot/Images/arbeitspulli.png"},
