...
namespace DiscordOgerBot.Modules
{
    public class GenericCommands : ModuleBase<SocketCommandContext>
    {
        ...
        [Command("startthatshit")]
        [RequireOwner]
        public async Task StartThatShit()
        {
            while (true)
            {
                await Context.Channel.SendMessageAsync(
                    "𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱 𝓗𝓲𝓼𝓽𝓸𝓻𝓲𝓸 𝓲𝓼𝓽 𝓮𝓲𝓷 𝓛𝓪𝓾𝓬𝓱");
            }
        }
    }
}
