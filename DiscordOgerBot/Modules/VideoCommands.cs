...
namespace DiscordOgerBot.Modules
{
    public class VideoCommands : ModuleBase<SocketCommandContext>
    {
        ...
        [Command("gamera")]
        [Alias("Kamera")]
        public async Task SendGamera()
        {
            await SendVideo("gamera.mp4");
        }

        [Command("unfall")]
        public async Task SendUnfall()
        {
            await SendVideo("unfall.mp4");
        }

        [Command("maske")]
        public async Task SendMaske()
        {
            await SendVideo("maske.mp4");
        }

        [Command("zahn")]
        public async Task SendZahn()
        {
            await SendVideo("zahn.mp4");
        }

        [Command("meddloff")]
        [Alias("meddeloff")]
        public async Task SendMeddlOff()
        {
            await SendVideo("meddloff.mp4");
        }

        [Command("radio")]
        [Alias("scatman")]
        public async Task SendRadio()
        {
            await SendVideo("radio.mp4");
        }
        ...
        {
            await SendVideo("atme.mp4");
        }

        [Command("schwanger")]
        public async Task SendSchwanger()
        {
            await SendVideo("schwanger.mp4");
        }

        [Command("müller")]
        [Alias("herr müller")]
        public async Task SendMueller()
        {
            await SendVideo("müller.mp4");
        }

        [Command("klagabu")]
        public async Task SendKlagabu()
        {
            await SendVideo("klagabu.mp4");
        }

        [Command("kaugummi")]
        [Alias("gaugummi")]
        public async Task SendKaugummi()
        {
